...
export const ArticulosList = () => {
  ...
  const handleDownloadQR = (sku: string, nombre: string) => {
    const img = new Image()
    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        link.href = url
        link.download = `QR-${nombre}-${sku}.png`
        link.click()
      }
    }
  }
  ...
  if (loadingArticulos) {
    return <div className="p-6 text-sm text-gray-400">Cargando artículos...</div>
  }
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-xl overflow-hidden relative">
      ...
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        <span className="text-[13px] font-medium text-gray-900">Artículos registrados</span>
        <button className="flex items-center gap-1.5 text-[12px] border border-gray-200 px-3 py-1.5 rounded-lg text-gray-500 hover:bg-gray-50">
          <Download size={13} /> Exportar
        </button>
      </div>

      {/* Buscador + filtros */}
      <div className="flex flex-col md:flex-row gap-2 px-4 py-3 border-b border-gray-100">
        <input
          type="text"
          placeholder="Buscar por nombre, modelo, SKU, talla..."
          value={busqueda}
      ...
      <div className="overflow-x-auto scrollbar-thin">
        <table className="w-full text-[13px] min-w-[640px]" style={{ tableLayout: 'fixed' }}>
          <colgroup>
            <col style={{ width: '22%' }} />
            <col style={{ width: '15%' }} />
            <col style={{ width: '15%' }} />
          ...
          <thead>
            <tr className="bg-gray-50">
              {['Artículo', 'Modelo', 'SKU', 'Talla', 'Color', 'Género', 'Precio venta', 'Stock', ''].map((h) => (
          ...
          <tbody>
            {filtrados.map((a) => {
              ...
              return (
                <tr key={a.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2.5 text-gray-800">{formatCurrency(a.precio_venta)}</td>
                  <td className="px-4 py-2.5">
            ...
            {filtrados.length === 0 && (
              <tr>
                <td colSpan={9} className="px-4 py-8 text-center text-[13px] text-gray-400">
      ...
      {articuloQr && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm border border-gray-100 overflow-hidden flex flex-col items-center p-6 text-center animate-in fade-in zoom-in-95 duration-200">
      ...
      {articuloEliminar && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm border border-gray-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
